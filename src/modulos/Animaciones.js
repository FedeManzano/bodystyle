/**
 * Animaciones utilitarias para efectos de acordeón.
 * Exporta dos funciones reutilizables: slideUp y slideDown.
 * Ambas usan la Web Animations API y aceptan un callback opcional.
 */
